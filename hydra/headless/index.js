...
const url = "https://main--cc--adobecom.aem.live/products/photoshop-lightroom?milolibs=local&georouting=off";
  await page.goto(url, {
...
document.querySelectorAll('picture').forEach(picture => {
  ...
  const secondHalf = cssEntries.slice(midPoint);
    ...
    .replace('</title>', `</title>
    <link rel="preload" as="image" href="https://www.adobe.com/products/media_1932f853d5dddbb1775f7f0e8333c2dfaa9cf9515.png?width=768&format=webply&optimize=medium" fetchpriority="high">`)
    .replace('</body>', 
